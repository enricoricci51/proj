...
********************************************************************/
    ...
    // required by Network Freezer feature.
        ...
        #define MAGNETIC_TRIS       TRISCbits.RC7
        #define MAGNETIC            PORTCbits.RC7   
    ...
    // Following definitions are used for LCD display on the demo board
        ...
        #define SUPPORT_TWO_SPI
        #define SPInCS_TRIS             TRISCbits.TRISC0
        #define SPInCS_LAT	        LATCbits.LATC0
    	#define	SPISSPSTAT	        SSPSTAT
    	#define SPISSPCON	        SSPCON1
    	#define SPISSPBUF	        SSPBUF
    	#define SPIWCOL		        SSPCON1bits.WCOL
    	#define SPISSPIE	        PIE1bits.SSPIE
    	#define SPISSPIF	        PIR1bits.SSPIF
