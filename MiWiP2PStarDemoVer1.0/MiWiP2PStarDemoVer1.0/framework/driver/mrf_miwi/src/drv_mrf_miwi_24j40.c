...
void PHYSetLongRAMAddr(INPUT uint16_t address, INPUT uint8_t value)
{
    ...
    RFIE = 0;
    PHY_CS = 0;
    SPI1_Exchange8bit((((uint8_t) (address >> 3))&0x7F) | 0x80);   // MCC_SPI
    SPI1_Exchange8bit((((uint8_t) (address << 5))&0xE0) | 0x10);   // MCC_SPI
    SPI1_Exchange8bit(value);   // MCC_SPI
    PHY_CS = 1;
    RFIE = tmpRFIE;
}
...
uint8_t PHYGetShortRAMAddr(INPUT uint8_t address)
{
    ...
    PHY_CS = 0;
    SPI1_Exchange8bit(address);    // MCC_SPI
    toReturn = SPI1_Exchange8bit(0x00);   // MCC_SPI
    PHY_CS = 1;
    RFIE = tmpRFIE;
...
uint8_t PHYGetLongRAMAddr(INPUT uint16_t address)
{
    ...
    RFIE = 0;
    PHY_CS = 0;
    SPI1_Exchange8bit(((address >> 3)&0x7F) | 0x80);  // MCC_SPI
    SPI1_Exchange8bit(((address << 5)&0xE0));    // MCC_SPI
    toReturn = SPI1_Exchange8bit(0x00);    // MCC_SPI
    PHY_CS = 1;
    RFIE = tmpRFIE;
