...
#define ENABLE_NETWORK_FREEZER
    ...
    // every 10 minutes the stack will find the inactive end nodes 
...
#if defined(PROTOCOL_STAR)
/*********************************************************************/
// MAKE_ENDDEVICE_PERMANENT defines FFD || RFD in PAN CO connection Table
// to be permanent and PAN CO does not expect link status from this particular 
// FFD
/*********************************************************************/
    //#define MAKE_ENDDEVICE_PERMANENT
    #define ENABLE_PERIODIC_CONNECTIONTABLE_SHARE
