...
void DemoOutput_Greeting(void)
{
            ...
            LCDDisplay((char *)"Simple P2P      MRF24J40 Node1", 0, true);
        #endif
        #if defined(PROTOCOL_STAR)
            LCDDisplay((char *)"Simple STAR     MRF24J40 Node1", 0, true);
        #endif
    #elif defined(MRF89XA)
        #if defined(PROTOCOL_P2P)
            LCDDisplay((char *)"Simple P2P      MRF89XA Node1", 0, true);
        #endif
        #if defined(PROTOCOL_STAR)
            LCDDisplay((char *)"Simple STAR     MRF89XA Node1", 0, true);
        #endif
    #endif
...
void STAR_DEMO_OPTIONS_MESSAGE(bool NetworkRole)
{
    ...
    {
        #if defined(EIGHT_BIT_WIRELESS_BOARD)
                LCDDisplay((char *)"PC :RB0 or RB2  to Broadcast msg", 0, false);
        #else
                LCDDisplay((char *)"PC :SW1 or SW2  to BroadCast msg", 0, false);
        #endif
    }
    else
    {
