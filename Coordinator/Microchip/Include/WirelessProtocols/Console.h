...
/************************ FUNCTION PROTOTYPES **********************/
        ...
        #define MAXRXBUFFERDIM              40
        #define MAXTXBUFFERDIM              40
        #define RXNOTEMPTY                  RxHead != RxTail
        #define TXNOTEMPTY                  TxHead != TxTail
        CONSOLE_EXTERN BYTE RxUSARTBuffer[MAXRXBUFFERDIM];
        CONSOLE_EXTERN BYTE RxTail;
        CONSOLE_EXTERN BYTE RxHead;
        CONSOLE_EXTERN BYTE TxUSARTBuffer[MAXTXBUFFERDIM];
        CONSOLE_EXTERN BYTE TxTail;
        CONSOLE_EXTERN BYTE TxHead;
        void ConsoleInit(void);
